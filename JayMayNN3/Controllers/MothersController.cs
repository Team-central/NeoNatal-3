...
namespace JayMayNN3.Controllers
{
    public class MothersController : Controller
    {
        ...
        {
            var mothers = db.Mothers.Include(m => m.Client);
            return View(mothers.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "ID,FirstName,LastName,DOB,Address,PhoneNumber,Email,ClientID")] Mother mother)
        {
            ...
            ViewBag.ClientID = new SelectList(db.Clients, "ID", "Username", mother.ClientID);
            return View(mother);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,FirstName,LastName,DOB,Address,PhoneNumber,Email,ClientID")] Mother mother)
        {
            if (ModelState.IsValid)
            {
